...
dname = 'Y:\Marie Shorrock\NTIP\Auditory Entrainment Study\Old_Freq_Analysis\Theta and Alpha\UNC\SeqD';
...
save('Ent_SD_UNC_averages.mat','av_area','entrainname','av_cell','grand_av_e','grand_av_b','grand_av'); % CAB: added av_cell - filenames and numbers all in one cell array
